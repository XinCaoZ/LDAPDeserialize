...
public interface IBurpCollaboratorClientContext
{
     ...
     * @throws IllegalStateException if Burp Collaborator is disabled
     */
    List<burp.IBurpCollaboratorInteraction> fetchAllCollaboratorInteractions();
     ...
     * @throws IllegalStateException if Burp Collaborator is disabled
     */
    List<burp.IBurpCollaboratorInteraction> fetchCollaboratorInteractionsFor(String payload);
     ...
     * @throws IllegalStateException if Burp Collaborator is disabled
     */
    List<burp.IBurpCollaboratorInteraction> fetchAllInfiltratorInteractions();
