...
public interface IBurpExtenderCallbacks
{
     ...
     */
    void registerHttpListener(burp.IHttpListener listener);
     ...
     * extension.
     */
    List<burp.IHttpListener> getHttpListeners();
     ...
     */
    void registerProxyListener(burp.IProxyListener listener);
     ...
     * extension.
     */
    List<burp.IProxyListener> getProxyListeners();
     ...
     */
    void registerScannerListener(burp.IScannerListener listener);
     ...
     * extension.
     */
    List<burp.IScannerListener> getScannerListeners();
     ...
     */
    void registerScopeChangeListener(burp.IScopeChangeListener listener);
     ...
     * this extension.
     */
    List<burp.IScopeChangeListener> getScopeChangeListeners();
     ...
     */
    void registerContextMenuFactory(burp.IContextMenuFactory factory);
     ...
     * this extension.
     */
    List<burp.IContextMenuFactory> getContextMenuFactories();
     ...
     */
    void registerScannerCheck(burp.IScannerCheck check);
     ...
     * extension.
     */
    List<burp.IScannerCheck> getScannerChecks();
     ...
     */
    void addSuiteTab(burp.ITab tab);
     ...
     */
    burp.IScanQueueItem doActiveScan(
            String host,
            int port,
            boolean useHttps,
            byte[] request);
     ...
     * response.
     */
    burp.IHttpRequestResponse makeHttpRequest(
            burp.IHttpService httpService,
            byte[] request);
     ...
     */
    burp.IHttpRequestResponse[] getProxyHistory();
     ...
     */
    burp.IHttpRequestResponse[] getSiteMap(String urlPrefix);
     ...
     */
    burp.IScanIssue[] getScanIssues(String urlPrefix);
    ...
    void generateScanReport(
            String format, burp.IScanIssue[] issues,
            java.io.File file);
     ...
     */
    List<burp.ICookie> getCookieJarContents();
     ...
     */
    void addToSiteMap(burp.IHttpRequestResponse item);
    ...
    IHttpRequestResponsePersisted saveBuffersToTempFiles(
            burp.IHttpRequestResponse httpRequestResponse);
