...
public interface IExtensionHelpers
{
     ...
     */
    burp.IRequestInfo analyzeRequest(IHttpRequestResponse request);
     ...
     * details about the request.
     */
    burp.IRequestInfo analyzeRequest(burp.IHttpService httpService, byte[] request);
     ...
     * not found.
     */
    burp.IParameter getRequestParameter(byte[] request, String parameterName);
     ...
     */
    byte[] addParameter(byte[] request, burp.IParameter parameter);
     ...
     */
    byte[] removeParameter(byte[] request, burp.IParameter parameter);
     ...
     */
    byte[] updateParameter(byte[] request, burp.IParameter parameter);
     ...
     * provided.
     */
    burp.IHttpService buildHttpService(String host, int port, String protocol);
